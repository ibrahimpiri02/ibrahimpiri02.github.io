...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-4 z-30 bg-white/90 backdrop-blur-md mx-auto max-w-7xl px-10 py-4 mt-4">
      <div className="flex justify-end items-center gap-8 font-navbar">
        {links.map((link) => {
